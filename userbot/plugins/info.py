...
async def fetch_info(replied_user, event):
    ...
    caption += f"<b>🖼 Numero di immagini profilo:</b> {replied_user_profile_photos_count}\n"
    caption += f"<b>🤖 E' un bot:</b> {is_bot}\n"
    caption += f"<b>🔏 E' limitato:</b> {restricted}\n"
